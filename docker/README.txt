...
===
   ...
   docker run -e 'ACCEPT_EULA=Y' -e 'SA_PASSWORD=Sql!Expre55' --name db -p 1401:1433 -d microsoft/mssql-server-linux

   /opt/mssql-tools/bin/sqlcmd -S 172.17.0.1,1433 -U sa -P 'Sql!Expre55'
